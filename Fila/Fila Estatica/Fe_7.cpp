...
//Receba uma fila estática e retorne quantas operações de pagamento foram feitas.
int Pagamentos(TipoFila fila){
	
	int i, cont=0;

	for(i=fila.frente;i != fila.tras; i=i% MAXTAM+1){
		
		if(strcmp(fila.item[i-1].operacao, "pagamento")==0){
...
main(){
	...
	printf("Pagamentos: %d", Pagamentos(fila));	
